...
function e(s, n) {
  ...
  return s.replace(/(%[a-f0-9]{2})+/gi, function (t) {
    ...
    for (let s = 0, n = t.length; s < n; s += 3) {
      const h = parseInt(t.slice(s + 1, s + 3), 16);
      if (h < 128) e += o[h];
      else {
        if (192 == (224 & h) && s + 3 < n) {
          const n = parseInt(t.slice(s + 4, s + 6), 16);
          if (128 == (192 & n)) {
            const t = ((h << 6) & 1984) | (63 & n);
            (e += t < 128 ? "��" : String.fromCharCode(t)), (s += 3);
            continue;
          }
        }
        if (224 == (240 & h) && s + 6 < n) {
          const n = parseInt(t.slice(s + 4, s + 6), 16),
            o = parseInt(t.slice(s + 7, s + 9), 16);
          if (128 == (192 & n) && 128 == (192 & o)) {
            const t = ((h << 12) & 61440) | ((n << 6) & 4032) | (63 & o);
            (e +=
        ...
        if (240 == (248 & h) && s + 9 < n) {
          const n = parseInt(t.slice(s + 4, s + 6), 16),
            o = parseInt(t.slice(s + 7, s + 9), 16),
            i = parseInt(t.slice(s + 10, s + 12), 16);
          if (128 == (192 & n) && 128 == (192 & o) && 128 == (192 & i)) {
            let t =
              ((h << 18) & 1835008) |
              ((n << 12) & 258048) |
              ((o << 6) & 4032) |
...
const s = {};
function n(t, e, o) {
  "string" != typeof e && ((o = e), (e = n.defaultChars)),
    void 0 === o && (o = !0);
  const h = (function (t) {
    let e = s[t];
    if (e) return e;
    ...
    for (let s = 0; s < t.length; s++) e[t.charCodeAt(s)] = t[s];
    return e;
  })(e);
  let i = "";
...
(h.prototype.parse = function (t, e) {
  let s,
    ...
    o,
    h = t;
  if (((h = h.trim()), !e && 1 === t.split("#").length)) {
    const t = a.exec(h);
  ...
  if (
    ...
    (e || r || h.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
      ((o = "//" === h.substr(0, 2)),
      !o || (r && g[r]) || ((h = h.substr(2)), (this.slashes = !0))),
    !g[r] && (o || (r && !C[r])))
  ) {
    let t,
      e,
    ...
    for (let t = 0; t < p.length; t++)
      (n = h.indexOf(p[t])), -1 !== n && (-1 === s || n < s) && (s = n);
    (e = -1 === s ? h.lastIndexOf("@") : h.lastIndexOf("@", s)),
      -1 !== e && ((t = h.slice(0, e)), (h = h.slice(e + 1)), (this.auth = t)),
      (s = -1);
    for (let t = 0; t < f.length; t++)
      (n = h.indexOf(f[t])), -1 !== n && (-1 === s || n < s) && (s = n);
    -1 === s && (s = h.length), ":" === h[s - 1] && s--;
    const o = h.slice(0, s);
    (h = h.slice(s)), this.parseHost(o), (this.hostname = this.hostname || "");
    const i =
      "[" === this.hostname[0] &&
      ...
      for (let e = 0, s = t.length; e < s; e++) {
        ...
        if (s && !s.match(u)) {
          ...
          for (let t = 0, e = s.length; t < e; t++)
            s.charCodeAt(t) > 127 ? (n += "x") : (n += s[t]);
          if (!n.match(u)) {
            const n = t.slice(0, e),
              o = t.slice(e + 1),
              i = s.match(m);
            i && (n.push(i[1]), o.unshift(i[2])),
              o.length && (h = o.join(".") + h),
  ...
  const l = h.indexOf("#");
  -1 !== l && ((this.hash = h.substr(l)), (h = h.slice(0, l)));
  const c = h.indexOf("?");
  return (
    -1 !== c && ((this.search = h.substr(c)), (h = h.slice(0, c))),
    h && (this.pathname = h),
    C[s] && this.hostname && !this.pathname && (this.pathname = ""),
    this
  );
}),
  (h.prototype.parseHost = function (t) {
    let e = r.exec(t);
    e &&
      ((e = e[0]),
...
export { e as decode, n as encode, o as format, d as parse };
export default null;
